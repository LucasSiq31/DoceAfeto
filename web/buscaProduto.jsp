...
<head>
    ...
    <%
        ...
        String pesquisa = (String) request.getAttribute("pesquisa");
    %>
            
    <title>Resultados para pesquisa '<%=pesquisa%>' | Doce Afeto</title>
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <h1>Resultados para a pesquisa '<%=pesquisa%>'</h1>
