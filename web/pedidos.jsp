...
<%-- 
    Document   : pedidos
    Created on : 29 de mai. de 2026, 13:52:26
    Author     : usuario
--%>
...
<head>
    ...
    <title>Pedidos | Doce Afeto</title>
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <form class="inputPesquisa" action="controle_pedido" method="GET">
                <input type="text" placeholder="Qual pedido você procura?" name="pesquisa">
                <button type="submit" name="op" value="pesquisarPedido">
            ...
            <div class="funcPedidos">
                <a href="controle_pedido?op=exibirTodos">Ver Todos</a>
                <a href="controle_pedido?op=exibirPendentes">Ver Pendentes</a>
                <a href="controle_pedido?op=exibirConcluidos">Ver Concluidos</a>
            </div>
            ...
            <div class="tabelaPedido">
                <table>
                    ...
                    <% 
                        ...
                        for(Pedido ped : lped){
                            String precoFormat = String.format("%.2f", ped.getTotal());
                    ...
                    <tr>
                        ...
                        <td><%out.print(ped.getProduto().getNome());%></td>
                        <td><%out.print(ped.getNome() + " " + ped.getSobrenome());%></td>
                        <td><%out.print("R$"+precoFormat);%></td>
                        <td><%out.print(dataFormatada);%></td>
                        <%
                    String classe = "pendente";

                    if("Concluído".equals(ped.getStatus())){
                        classe = "concluido";
                    }
                    %>

                    <td class="<%= classe %>"><%= ped.getStatus() %></td>
                        <td><a href="<%out.print("controle_pedido?op=exibirPedido&id=" + ped.getId());%>">Exibir Detalhes</a></td>
                    </tr>
