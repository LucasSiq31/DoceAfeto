<%-- 
    ...
    Created on : 28 de mai. de 2026, 13:15:13
    Author     : usuario
--%>
...
<head>
    ...
    <title><%out.print(prod.getNome());%> | Doce Afeto</title>
...
<body>
        ...
        <div class="container">
            ...
            <form action="controle_pedido" method="GET">
                <div id="passo1" class="passo">
                    ...
                    <h2>Produto: </h1>
                    <div class="cardProdP">
                        <input type="hidden" name='idProd' value='<%out.print(prod.getId());%>'>
                        <img src="<%out.print(prod.getImagem());%>" alt="">
                        <div>
                            <p><%out.print(prod.getNome());%> - <%out.print(prod.getDescricao());%></p>
                            <p><b>R$<%=precoFormat%></b>/uni</p>
                            <span class="quantidade">
                                <button type="button" onclick="removeQtd()">-</button>
                                <input type="number" id="qtd" value="1" name="quantidade" required>
                                <button type="button" onclick="addQtd()">+</button>
                            </span>
                        </div>
                    </div>
                    ...
                    <p class="total"><b>Subtotal:</b> <span class="subtotal">R$<%=precoFormat%></span></p>
                ...
                <div id="passo2" class="passo">
                    ...
                    <h2>Por favor, preencha os campos abaixo para que possamos preparar e enviar a sua compra.</h2>

                    <input type="text" placeholder="Nome" name="nome" maxlength="50" required>
                    <input type="text" placeholder="Sobrenome" name="sobrenome" maxlength="50" required>
                    <input type="number" placeholder="Telefone" name="telefone" required oninput="if(this.value.length > 11) this.value = this.value.slice(0, 11);">

                    <button type="button" onclick="avancoCliente()">Continuar</button>
                </div>
                ...
                <div id="passo3" class="passo">
                    ...
                    <h2>Insira os dados para entrega: </h2>
                    <input type="number" placeholder="CEP" id="cep" name="cep" oninput="if(this.value.length > 8) this.value = this.value.slice(0, 8);" required>
                    <input type="text" placeholder="Rua" id="rua" readonly >
                    ...
                    <p class="pagamento"><b>Frete:</b> <span id="pedidoFrete">Calculando . . .</span></p>
                    <button type="button" onclick="avancoCep()" id="btnCep">Continuar</button>
                </div>
                ...
                <div id="passo4" class="passo">
                    ...
                    <h2>Escolha a forma de pagamento: </h1>

                    <label class="opcao caixa" for="pix">
                        <input type="radio" id="pix" name="pagamento" checked required>
                        <span class="rad"></span>
                        Pix
                    </label>

                    <label class="opcao caixa" for="credito">
                        <input type="radio" id="credito" name="pagamento" required>
                        <span class="rad"></span>
                        Cartão de Crédito
                    </label>

                    <label class="opcao caixa" for="debito">
                        <input type="radio" id="debito" name="pagamento" required>
                        <span class="rad"></span>
                        Cartão de Débito
                    </label>

                    <label class="opcao caixa" for="dinheiro">
                        <input type="radio" id="dinheiro" name="pagamento" required>
                        <span class="rad"></span>
                        Dinheiro
                    </label>

                    <div class="linha"></div>
                    <p class="pagamento"><b>Produto:</b> R$<%=precoFormat%> <span class="totalQtd">x 1</span></p>
                    <p class="pagamento"><b>Frete:</b> <span id="totalFrete">Calculando . . .</span></p>
                    <p class="total"><b>Total:</b> <span id="total">R$00,00</span></p>

                    <input type="hidden" id="frete" name="frete">

                    <button type="submit" name="op" value="Cadastrar" onclick="verificarTudo()">Efetuar Pagamento</button>
                </div>
            </form>

            <!-- ALERT -->
            <div class="fundoAlert" id="alertPedido">
                <div class="alert">
                    <div class="conteudo">
                        <p>Há campos incompletos! Verifique se todos os dados estão preenchidos.</p>
                    </div>
                    <button onclick="fechar('alertPedido')">Ok</button>
                </div>
            </div>
    ...
    <script src="script/efetuarPedido.js"></script>
