<%-- 
    Document   : index
    Created on : 29 de mai. de 2026, 09:22:14
    Author     : usuario
--%>
...
<head>
    ...
    <title>Página Inicial | Doce Afeto</title>
...
<body>
    ...
    <nav>
        <div class="menu">
            ...
            <a href="controle_produto?op=home" class="selected">
    ...
    <main>
        <div class="container">
            <form class="inputPesquisa" action="controle_produto" method="GET">
                ...
                <button type="submit" name="op" value="pesquisarProduto">
            ...
            <%
                List<Produto> ldoce = (List<Produto>) request.getAttribute("ldoce");
                List<Produto> ltorta = (List<Produto>) request.getAttribute("ltorta");
                List<Produto> lbolo = (List<Produto>) request.getAttribute("lbolo");
            %>
            ...
            <section>
                ...
                <div class="cardProdM">
                    ...
                    <div>
                        ...
                        <a href=<%out.print("controle_produto?op=exibirProduto&id=" + prod.getId());%>>Comprar</a>
                    </div>
                </div>
